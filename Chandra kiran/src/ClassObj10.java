...
public class ClassObj10 
{
    public static void main(String[] args) 
    {
        ...
        Employee obj2 = new Employee("John", 1999, 600000, "268-WallsStreet");
        System.out.println("Name\tYear of joining\t\tsalary\t\t Address");
        System.out.println(obj.getName() + "\t\t" + obj.getYear() + "\t\t" + obj.getSalary() + "\t" + obj.getAddress() );
        System.out.println(obj1.getName() + "\t\t" + obj1.getYear() + "\t\t" + obj1.getSalary() + "\t" + obj1.getAddress() );
        System.out.println(obj2.getName() + "\t\t" + obj2.getYear() + "\t\t" + obj2.getSalary() + "\t" + obj2.getAddress() );
