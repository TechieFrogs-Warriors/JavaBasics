...
{
    // program to get the index of all the characters of the string
    public static void main(String[] args) 
    {
        String str = "The quick brown fox jumps over the lazy dog.";
        System.out.println(str.length());

        //getting the index position of alphabet int given string
        ...
        // Printing all alphabet indexes present in the given string
